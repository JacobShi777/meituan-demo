<template>
  <view class="nav">
    ...
    <view
      ...
      :class="{ fixed: mysNavConfig.navFixed }"
    >
      <view class="my_left_box" :style="{ height: btnHeight }" v-if="!hideDefaultLeft">
        <!-- 左侧单图标 + text -->
      ...
      <view class="btn_type" :style="{ height: btnHeight }">
        ...
        <view class="my_custom_box" :style="{ height: btnHeight }">
          ...
          >
            <image class="nv_icon" :src="`/static/MysNavBar/searchB.png`" mode="aspectFit" />
            <input
              type="text"
            ...
            <view class="close" @tap="clearInput" :style="{ height: inputHeight }">
              <image
                ...
                class="nv_icon"
                :src="`/static/MysNavBar/colse_fill.png`"
                mode="aspectFit"
              />
            </view>
          </view>
...
<script>
/* 默认首页路径 */
const homePath = "/pages/homepage/homepage";
/* 默认首页图标路径 */
const homeIconPath = "/static/MysNavBar/home_b.png";
/* 默认返回图标路径 */
const backIconPath = "/static/MysNavBar/back_b.png";
export default {
  props: {
    mysNavConfig: {
      type: Object,
      default() {
        return {
          ...
          type2Config: {
            // 左图标
            leftPath: "/static/MysNavBar/back_w.png",
            // 右图标
            rightPath: "/static/MysNavBar/home.png",
            // 圆角
            radius: "40rpx",
          },
          /* 搜索框配置 */
		  ...
		  hideDefaultLeft: false, // 显示左侧默认的名称，如返回箭头
        };
      },
    },
    scrollTop: {
  ...
  methods: {
    init() {
	  ...
	  if (this.mysNavConfig.hideDefaultLeft) {
		  this.hideDefaultLeft = this.mysNavConfig.hideDefaultLeft
	  }
    },
    /* 小程序初始化位置 */
    initMP() {
